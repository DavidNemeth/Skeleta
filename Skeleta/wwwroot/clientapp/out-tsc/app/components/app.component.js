...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        setTimeout(function () {
            if (_this.isUserLoggedIn) {
                ...
                _this.alertService.showMessage('Login', "Welcome back " + _this.userName + "!", MessageSeverity.default);
                // else
        ...
        this.authService.getLoginStatusEvent().subscribe(function (isLoggedIn) {
            ...
            setTimeout(function () {
                if (!_this.isUserLoggedIn) {
                    _this.alertService.showMessage('Session Ended!', '', MessageSeverity.default);
                }
            }, 500);
        });
    ...
    AppComponent.prototype.markNotificationsAsRead = function () {
        ...
        if (recentNotifications.length) {
            this.notificationService.readUnreadNotification(recentNotifications.map(function (n) { return n.id; }), true)
                ...
                _this.alertService.logError(error);
                _this.alertService.showMessage('Notification Error', 'Marking read notifications failed', MessageSeverity.error);
            });
        }
    };
    ...
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [LocalStoreManager, ToastaService,
            ToastaConfig,
            Router, AccountService,
            AlertService, NotificationService,
            AppTitleService, AuthService,
            AppTranslationService, ConfigurationService])
    ], AppComponent);
    return AppComponent;
}());
export { AppComponent };
