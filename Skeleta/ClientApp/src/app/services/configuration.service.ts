...
export class ConfigurationService {
  ...
  set showUserManagement(value: boolean) {
    this._showUserManagement = value;
    this.saveToLocalStore(value, DBkeys.SHOW_USER_MANAGEMENT);
  }

  set showRoleManagement(value: boolean) {
    this._showRoleManagement = value;
    this.saveToLocalStore(value, DBkeys.SHOW_ROLE_MANAGEMENT);
  }
