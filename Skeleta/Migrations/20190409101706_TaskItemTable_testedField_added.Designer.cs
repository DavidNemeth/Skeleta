...
namespace Skeleta.Migrations
{
    ...
    [Migration("20190409101706_TaskItemTable_testedField_added")]
    partial class TaskItemTable_testedField_added
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Models.ProjectModel.Project", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DAL.Models.ProjectModel.ProjectMember", b =>
                {
            ...
            modelBuilder.Entity("DAL.Models.TaskModel.BugItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DAL.Models.TaskModel.BugItem", b =>
                {
                    b.HasOne("DAL.Models.ApplicationUser", "Developer")
                        .WithMany("DeveloperBugItems")
                        .HasForeignKey("DeveloperId");

                    b.HasOne("DAL.Models.TaskModel.TaskItem", "TaskItem")
                        .WithMany("BugItems")
